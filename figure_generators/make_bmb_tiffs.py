...
Bulletin of Mathematical Biology (Springer) follows the standard Springer
...
Figure_N/02_make_figure.py already writes -- those compile sn-article.pdf.
...
`supplementary_figures/S5/`; Figures 8 and 9 written by their own
