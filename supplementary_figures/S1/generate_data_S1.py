...
scale and replicate count) and the ESM_1.tex OR1-S2/OR1-S4/OR1-S5 tables.

Unlike the smaller 30-cell pilot this script previously ran, this now
reproduces the full crossed design ESM_1.tex documents: 195 raw-rate
...
exactly the three summary tables and the OR1-S5 text statistics quoted in
ESM_1.tex, with no further simulation.
...
def main() -> None:
    ...
    # --- OR1-S5 top-level descriptive statistics. ---------------------------
