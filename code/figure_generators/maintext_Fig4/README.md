> **This pipeline produces `Fig7.pdf`, which appears in the paper as main-text Figure 4.**
...
2. `python 02_make_figure.py`
   ...
   to `../../figures/Fig7.pdf`, the exact path `manuscript.tex` includes
...
(verified in `suppl_FigS8/01_generate_data.py` and `maintext_Fig5/01_generate_data.py`).
