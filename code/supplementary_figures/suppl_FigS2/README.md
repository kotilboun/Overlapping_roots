> **This pipeline produces `supp_S1_convergence_U8000.pdf`, which appears in the paper as Supplementary Material 1, Fig. S2.**
...
Reproduces the supplementary_material_1.tex S5.2/S5.4/S5.5 tables and Fig. S1: the full
...
descriptive log-log slopes) quoted in supplementary_material_1.tex, with no further
...
supplementary_material_1.tex's stated `2.99e-10` to 3 significant figures despite using an
