> **This pipeline produces `supp_S5_event_term_validation.pdf`, which appears in the paper as Supplementary Material 1, Fig. S6.**
...
`MANIFEST.txt`/`SHA256SUMS.txt` and packaged in `supplementary_material_3.zip`). Both the model
